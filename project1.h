...
char authors[8][20]={{"Philip Roth"}, {"Dan Brown"}, {"Charlotte Bronte"}, {"Stephenie Meyer"},
{"Katarzyna Grochola"}, {"J.K. Rowling"}, {"Veronica Roth"}, {"Yann Martel"}
};

// predefined titles of books; there are 8 books
char titles[8][20]={{"Nemesis"}, {"Origin"}, {"Jane Eyre"}, {"The host"},
{"Zielone drzwi"}, {"Harry Potter"}, {"Divergente"}, {"Life of Pi"}
};
